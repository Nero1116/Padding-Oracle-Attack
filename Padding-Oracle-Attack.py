...
if __name__== "__main__":
    ...
    plaintext = "This attack completely breaks any block cipher using CBC mode, given a padding oracle. Implementation should be switched to more secure modes, such as CTR."
    key=key[:32]
